...
#  Autor               : Arthur Gabriel, 2019
#  Universidade        : UFSJ, Departamento de Ciência da Computação
...
# Teste para ver se o algoritmo aprende o próximo número de uma sequência.
# Serve para observar se o método está convergindo para a solução
